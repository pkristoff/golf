...
describe RoundInfo9, type: :model do
  ...
  before do
    ...
    @round2 = RoundInfoSpecHelper.create_round9(113, 27, 1, 1, RoundInfoSpecHelper::ROUND_SCORE_INFO_BLACK9)
  ...
  it 'include?' do
    ...
    @round3 = RoundInfoSpecHelper.create_round9(113, 27, 1, 1, RoundInfoSpecHelper::ROUND_SCORE_INFO_BLACK9)
