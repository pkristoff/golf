...
describe Account, type: :model do
  ...
  let(:gl_account) { described_class.create(name: 'Paul', handicap_index: 0.0) }

  describe 'handicap_index' do
    describe 'calc_handicap_index' do
      it '0 rounds' do
        account = described_class.find_by(id: gl_account.id)
        account.calc_handicap_index
        expect(account.handicap_index).to eq(0.0)
      end

      it '1 rounds' do
        RoundInfoSpecHelper.create_round18(5, 1, RoundInfoSpecHelper::ROUND_SCORE_INFO_BLACK18, 139, 71.6)
        account = described_class.find_by(id: gl_account.id)
        account.calc_handicap_index
      ...
      it '3 rounds different course' do
        RoundInfoSpecHelper.create_round18(3, 1, RoundInfoSpecHelper::ROUND_SCORE_INFO_BLACK18, 139, 71.6)
        RoundInfoSpecHelper.create_round18(4, 1, RoundInfoSpecHelper::ROUND_SCORE_INFO_BLACK18, 113, 79.0)
        RoundInfoSpecHelper.create_round18(5, 1, RoundInfoSpecHelper::ROUND_SCORE_INFO_BLACK18, 110, 67)
        account = described_class.find_by(id: gl_account.id)
        account.calc_handicap_index
    ...
    describe 'find_rounds' do
      describe 'find_9_hole_round_infos_with_matching9' do
        it '0 rounds' do
          expect(described_class.find_9_hole_round_infos_with_matching9.size).to eq(0)
        end
        ...
        it '2 rounds same date' do
          RoundInfoSpecHelper.create_round9(1, 0, RoundInfoSpecHelper::ROUND_SCORE_INFO_BLACK9, 113, 71)
          RoundInfoSpecHelper.create_round9(1, 0, RoundInfoSpecHelper::ROUND_SCORE_INFO_BLACK9, 113, 71)
          all_round_info_sorted = described_class.find_9_hole_round_infos_with_matching9
        ...
        it '3 rounds same date' do
          ...
          all_round_info_sorted = described_class.find_9_hole_round_infos_with_matching9.sort_by(&:date)

          expect(all_round_info_sorted.size).to eq(1)
          expect(all_round_info_sorted.first.includes?(round1)).to be(true)
          expect(all_round_info_sorted.first.includes?(round2)).to be(true)
          expect(all_round_info_sorted.first.includes?(round3)).to be(false)
        end
      ...
      describe 'all_round_infos' do
        it 'no rounds' do
          expect(described_class.all_round_infos.size).to eq(0)
        end
        ...
        it 'one 9-hole round one 18-hole' do
          ...
          all_round_info_sorted = described_class.all_round_infos.sort_by(&:date)
          expect(all_round_info_sorted.size).to eq(1)
          expect(all_round_info_sorted.first.includes?(round18)).to be(true)
        end
        ...
        it 'two 9-hole rounds same date one 18-hole' do
          ...
          expect(all_round_info_sorted.first.includes?(round9_a)).to be(true)
          expect(all_round_info_sorted.first.includes?(round9_b)).to be(true)
          expect(all_round_info_sorted.second.includes?(round18)).to be(true)
        end
        ...
        it 'three 9-hole rounds same date one 18-hole' do
          ...
          expect(all_round_info_sorted.first.includes?(round9_a)).to be(true)
          expect(all_round_info_sorted.first.includes?(round9_b)).to be(true)
          expect(all_round_info_sorted.first.includes?(round9_c)).to be(false)
          expect(all_round_info_sorted.second.includes?(round18)).to be(true)
        end
        ...
        it 'four 9-hole rounds same date around one 18-hole' do
          ...
          expect(all_round_info_sorted.first.includes?(round9_b)).to be(true)
          expect(all_round_info_sorted.second.includes?(round18)).to be(true)
          expect(all_round_info_sorted.third.includes?(round9_c)).to be(true)
          expect(all_round_info_sorted.third.includes?(round9_d)).to be(true)
        end
      end
  ...
  describe 'course_handicap' do
    it '1 rounds' do
      ...
      account = described_class.find_by(id: gl_account.id)
      expect(account.calc_course_hdcp(round)).to be_nil
    end
  ...
  def set_handicap_index(account_id, handicap)
    account = described_class.find_by(id: account_id)
  ...
  def create_two_rounds
    RoundInfoSpecHelper.create_round18(3, 1, RoundInfoSpecHelper::ROUND_SCORE_INFO_BLACK18, 139, 71.6)
    RoundInfoSpecHelper.create_round18(4, 2, RoundInfoSpecHelper::ROUND_SCORE_INFO_BLACK18, 139, 71.6)
    10.6
  end

  def create_six_rounds
    RoundInfoSpecHelper.create_round18(3, 1, RoundInfoSpecHelper::ROUND_SCORE_INFO_BLACK18, 139, 79)
    RoundInfoSpecHelper.create_round18(4, 1, RoundInfoSpecHelper::ROUND_SCORE_INFO_BLACK18, 113, 79)
    RoundInfoSpecHelper.create_round18(5, 1, RoundInfoSpecHelper::ROUND_SCORE_INFO_BLACK18, 110, 67)
