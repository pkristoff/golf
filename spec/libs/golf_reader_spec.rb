...
describe GolfReader, type: :lib do
  describe 'Reading excel spreadsheet' do
    ...
    it 'read' do
      ...
      @golf_reader_spec.expect_knights_play_course(golf_reader.course("Knight's play 1-9"),
                                                   "Knight's play 1-9",
                                                   TeeHoleInfo::HOLE_INFO_KN_1_9)
      @golf_reader_spec.expect_knights_play_course(golf_reader.course("Knight's play 10-18"),
                                                   "Knight's play 10-18",
                                                   TeeHoleInfo::HOLE_INFO_KN_10_18)
      @golf_reader_spec.expect_knights_play_course(golf_reader.course("Knight's play 19-27"),
                                                   "Knight's play 19-27",
                                                   TeeHoleInfo::HOLE_INFO_KN_19_27)
      course = golf_reader.course('Lochmere')
      @golf_reader_spec.expect_lochmere(course)
    end
    it 'read rounds' do
      golf_reader = GolfReader.new('spec/fixtures/Golf.xlsx')
      ...
      TeeHoleInfo::HOLE_INFO_LOCHMERE[:Blue_rounds].each do |round_info|
        @golf_reader_spec.expect_lochmere_round(golf_reader.round(Date.strptime(round_info[0], '%m/%d/%y'),
                                                                  course,
                                                                  'Blue'),
                                                round_info[1..20])
      end
    ...
    it 'reads and saves to DB' do
      ...
      @golf_reader_spec.expect_knights_play_course(Course.find_by(name: "Knight's play 1-9"),
                                                   "Knight's play 1-9",
                                                   TeeHoleInfo::HOLE_INFO_KN_1_9)
      @golf_reader_spec.expect_knights_play_course(Course.find_by(name: "Knight's play 10-18"),
                                                   "Knight's play 10-18",
                                                   TeeHoleInfo::HOLE_INFO_KN_10_18)
      @golf_reader_spec.expect_knights_play_course(Course.find_by(name: "Knight's play 19-27"),
                                                   "Knight's play 19-27",
                                                   TeeHoleInfo::HOLE_INFO_KN_19_27)
      @golf_reader_spec.expect_lochmere(course)
    end
...
class GolfReaderSpec
  ...
  # Expecting of a lockmere Course
  #
  # === Parameters:
  #
  # * <tt>:course</tt> Course
  ...
  # Compare readiong of xlsx worksheet course for knights plasy golf course
  #
  # === Parameters:
  #
  # * <tt>:course</tt> Course
  # * <tt>:name</tt> name of expected Course
  # * <tt>:hole_info</tt>Hash of tee color, which is an Array of Array [hole_number, yardage, par, hdcp]
  #
  ...
  #
  # * <tt>:round</tt> Round
  # * <tt>:score_info</tt>Array of Array [hole number, strokes, putts]
  #
  ...
  # Compare reading of xlsx worksheet round for lockmere golf course
  #
  # === Parameters:
  #
  # * <tt>:round</tt> Round
