...
describe 'rounds/index.html.erb', type: :view do
  ...
  it 'no rounds' do
    ...
    RoundsCommon.expect_rounds_index(rendered, course1, course_tee, course_tee.rounds, true)
  end
  it 'show rounds' do
    ...
    RoundsCommon.expect_rounds_index(rendered, course, tee, tee.rounds, true)
  end
end
